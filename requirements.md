...
5. Clones this repo: `https://github.com/nikkaushal/roboshop-v1.git`
...
3. S3 bucket `terraform-state-d88-nk` exists in `us-east-1`.
4. No EC2 key pair required — SSH uses `ec2-user` / `DevOps321` only.

### Commands (on jump EC2)

```bash
git clone https://github.com/nikkaushal/roboshop-v1.git
